...
import RelatedProduct from '../Componnets/RelatedProduct';

const Product = () => {
  const { productId } = useParams(); // Get product ID from the route
  const { products,currency,addToCart } = useContext(ShopContext); // Get all products from context
  const [productData, setProductData] = useState(false);
  const [image, setImage] = useState('');
  //create variable for selected size highlighted
